...
} from "~/components/jobs/job-creation-stepper";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function JobsPage() {
  ...
  const detectChanges = () => {
    ...
    if (originalState.clientId !== modalClientId) {
      ...
      changes.client = {
        from: oldClient
          ? `${oldClient.name} (${oldClient.companyName})`
          : "None",
                        ...
                        <SelectContent>
                          {clients.length > 0 ? (
                            ...
                            <div className="px-2 py-1.5 text-sm text-muted-foreground">
                              No clients available. Please create a client
                              first.
                            </div>
                          )}
                        </SelectContent>
