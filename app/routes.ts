...
export default [
  ...
  route("dashboard", "routes/dashboard.tsx", [
    ...
    route("workflow", "dashboard/workflow/kanban-workflow-management.tsx"),
    route("workflow/job-specific", "dashboard/workflow/job-workflow.tsx"),
    ...
    route("interviews", "dashboard/interviews/interview-manager.tsx"),
    route("offers", "dashboard/offers/route.tsx"),
